...
import javax.swing.JOptionPane; //buat nampilin massage
...
public class Menu extends javax.swing.JFrame {
    ...
    private ArrayList<Mahasiswa> listMhs; //kenapa bisa akses padahal ga di import? karena masih satu packages dan dia public
    /**
    ...
    public Menu() {
        ...
        // Dummy
        listMhs.add(new Mahasiswa("2105885", "Ainii", "A", "Perempuan"));
        listMhs.add(new Mahasiswa("2105354", "Adit", "B", "Laki-laki"));
        listMhs.add(new Mahasiswa("2109845", "Shawn", "C", "Laki-laki"));
    ...
    public void insertData() {
        ...
        if(!nim.isEmpty()&& !nama.isEmpty() && !nilai.isEmpty() && !gender.isEmpty())
        {
            ...
            JOptionPane.showMessageDialog(null, "Data berhasll ditambahkan!"); 
        }else{
    ...
    public void updateData() {
        ...
        if(!nim.isEmpty() && !nama.isEmpty() && !nilai.isEmpty() && !gender.isEmpty())
        {
            ...
            JOptionPane.showMessageDialog(null, "Data berhasll diperbarui!"); 
        }else{
